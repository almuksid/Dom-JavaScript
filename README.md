...
---
---
# 11. Implement color change, title update, and task list with checkboxes

```html
<h2 id="formCon">Form Control</h2>
<input type="submit" value="Click Me" id="clickBtn">
<input type="color" name="" id="clickColor">


<form action="" id="evForm">
    <input type="text" name="" id="inputEv">
    <input type="submit" value="Add an event" id="inputEv">
</form>
<ul id="evUl"></ul>
```
